...
<html>
    ...
    <body>
        ...
        <div id="show-comuna" class="content scaffold-show" role="main">
            ...
            <g:render template="form" model="[comuna: comuna, modoEdicion:false]"/>
            <g:form action="delete" id="${comuna.id}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" id="${this.comuna?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
